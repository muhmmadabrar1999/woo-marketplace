...
namespace Woo\Ecommerce\Http\Controllers\Customers;
...
use Woo\Ecommerce\Forms\CustomerForm;
use Woo\Ecommerce\Http\Requests\AddCustomerWhenCreateOrderRequest;
use Woo\Ecommerce\Http\Requests\CustomerCreateRequest;
use Woo\Ecommerce\Http\Requests\CustomerEditRequest;
use Woo\Ecommerce\Http\Requests\CustomerUpdateEmailRequest;
use Woo\Ecommerce\Http\Resources\CustomerAddressResource;
use Woo\Ecommerce\Repositories\Interfaces\AddressInterface;
use Woo\Ecommerce\Repositories\Interfaces\CustomerInterface;
use Woo\Ecommerce\Tables\CustomerTable;
use Carbon\Carbon;
use Exception;
