...
use Woo\Ecommerce\Facades\FlashSaleFacade;
...
use Woo\Payment\Services\Gateways\BankTransferPaymentService;
use Woo\Payment\Services\Gateways\CodPaymentService;
use Woo\Payment\Supports\PaymentHelper;
use Woo\Theme\Supports\ThemeSupport;
use Carbon\Carbon;
use Cart;
use EcommerceHelper;
use EmailHandler;
