...
namespace Woo\Ecommerce\Traits;
...
use Woo\Ecommerce\Http\Requests\CreateProductWhenCreatingOrderRequest;
use Woo\Ecommerce\Http\Requests\ProductUpdateOrderByRequest;
use Woo\Ecommerce\Http\Requests\ProductVersionRequest;
...
use Woo\Ecommerce\Services\Products\CreateProductVariationsService;
use Woo\Ecommerce\Services\Products\StoreAttributesOfProductService;
use Woo\Ecommerce\Services\Products\StoreProductService;
use EcommerceHelper;
use Exception;
