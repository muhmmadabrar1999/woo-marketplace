                            ...
                            <div class="position-relative">
                                ...
                                <ul class="list-group list_payment_method">
                                    @php
                                        ...
                                        $default = \Woo\Payment\Supports\PaymentHelper::defaultPaymentMethod();
                                    ...
                                    @if (get_payment_setting('status', 'cod') == 1)
                                        <li class="list-group-item">
                                            <input class="magic-radio js_payment_method" type="radio" name="payment_method" id="payment_cod"
                                                @if ($selecting == \Woo\Payment\Enums\PaymentMethodEnum::COD) checked @endif
                                            ...
                                            <div class="payment_cod_wrap payment_collapse_wrap collapse @if ($selecting == \Woo\Payment\Enums\PaymentMethodEnum::COD) show @endif" style="padding: 15px 0;">
                                    ...
                                    @if (get_payment_setting('status', 'bank_transfer') == 1)
                                        <li class="list-group-item">
                                            <input class="magic-radio js_payment_method" type="radio" name="payment_method" id="payment_bank_transfer"
                                                @if ($selecting == \Woo\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER) checked @endif
                                                value="bank_transfer"
                                            ...
                                            <div class="payment_bank_transfer_wrap payment_collapse_wrap collapse @if ($selecting == \Woo\Payment\Enums\PaymentMethodEnum::BANK_TRANSFER) show @endif" style="padding: 15px 0;">
