...
Route::group(['namespace' => 'Woo\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
...
Route::group(['namespace' => 'Woo\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core']], function () {
