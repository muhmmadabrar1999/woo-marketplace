...
namespace Woo\Marketplace\Supports;

use Woo\Ecommerce\Enums\DiscountTypeOptionEnum;
...
class MarketplaceHelper
{
    ...
    public function setEmailVendorVariables(OrderModel $order): \Woo\Base\Supports\EmailHandler
    {
