...
use Woo\Ecommerce\Models\Order as OrderModel;
...
use Woo\Ecommerce\Services\HandleApplyPromotionsService;
...
use Woo\Marketplace\Models\CategoryCommission;
...
class OrderSupportServiceProvider extends ServiceProvider
{
    ...
    public function setEmailVariables(Collection $orders): \Woo\Base\Supports\EmailHandler
    {
