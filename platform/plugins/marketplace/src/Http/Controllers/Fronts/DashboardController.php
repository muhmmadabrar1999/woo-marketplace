...
use Woo\Marketplace\Http\Requests\BecomeVendorRequest;
...
use Woo\Media\Chunks\Exceptions\UploadMissingFileException;
use Woo\Media\Chunks\Handler\DropZoneUploadHandler;
use Woo\Media\Chunks\Receiver\FileReceiver;
use EcommerceHelper;
use Exception;
