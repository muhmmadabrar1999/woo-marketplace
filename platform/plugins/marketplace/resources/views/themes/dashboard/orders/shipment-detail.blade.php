            ...
            <div class="flexbox-content">
                @if (MarketplaceHelper::allowVendorManageShipping() ||
                    in_array($shipment->status, [
                        \Woo\Ecommerce\Enums\ShippingStatusEnum::PENDING,
                        \Woo\Ecommerce\Enums\ShippingStatusEnum::APPROVED,
                        \Woo\Ecommerce\Enums\ShippingStatusEnum::ARRANGE_SHIPMENT,
                        \Woo\Ecommerce\Enums\ShippingStatusEnum::READY_TO_BE_SHIPPED_OUT
                    ]))
