...
namespace Woo\Ads\Providers;

use AdsManager;
use Woo\Ads\Facades\AdsManagerFacade;
use Woo\Ads\Models\Ads;
use Woo\Ads\Repositories\Caches\AdsCacheDecorator;
use Woo\Ads\Repositories\Eloquent\AdsRepository;
