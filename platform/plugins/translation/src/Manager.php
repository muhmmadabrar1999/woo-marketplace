...
namespace Woo\Translation;

use ArrayAccess;
use BaseHelper;
use Woo\Base\Supports\PclZip as Zip;
use Woo\Translation\Models\Translation;
use Exception;
...
class Manager
{
    ...
    public function getRemoteAvailableLocales(): array
    {
        ...
        try {
            $info = $client->request('GET', 'https://api.github.com/repos/Woo/translations/git/trees/master', [
                'headers' => [
    ...
    {
        $repository = 'https://github.com/Woo/translations';
