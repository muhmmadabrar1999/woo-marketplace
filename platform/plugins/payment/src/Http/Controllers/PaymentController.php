...
namespace Woo\Payment\Http\Controllers;
...
use Woo\Payment\Http\Requests\PaymentMethodRequest;
use Woo\Payment\Http\Requests\UpdatePaymentRequest;
use Woo\Payment\Repositories\Interfaces\PaymentInterface;
use Woo\Payment\Tables\PaymentTable;
