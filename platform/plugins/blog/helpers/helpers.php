...
use Woo\Base\Supports\SortItemsWithChildrenHelper;
...
if (! function_exists('get_posts_by_category')) {
    function get_posts_by_category(int $categoryId, int $paginate = 12, int $limit = 0): Collection|LengthAwarePaginator
    {
