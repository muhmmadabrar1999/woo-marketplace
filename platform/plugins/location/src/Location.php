...
use Woo\Base\Models\BaseQueryBuilder;
...
class Location
{
    ...
    public function getRemoteAvailableLocations(): array
    {
        ...
        try {
            $info = $client->request('GET', 'https://api.github.com/repos/Woo/locations/git/trees/master', [
                'headers' => [
    ...
    {
        $repository = 'https://github.com/Woo/locations';
