...
use Woo\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Woo\ACL\Http\Controllers\Auth\LoginController;
use Woo\ACL\Http\Controllers\Auth\ResetPasswordController;
use Woo\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Woo\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
