...
namespace Woo\ACL\Http\Controllers;

use Assets;
use Woo\Base\Events\UpdatedContentEvent;
use Woo\Media\Services\ThumbnailService;
use Carbon\Carbon;
use Illuminate\Support\Facades\File;
use Illuminate\Support\Facades\Auth;
use Woo\ACL\Forms\PasswordForm;
use Woo\ACL\Forms\ProfileForm;
use Woo\ACL\Forms\UserForm;
use Woo\ACL\Tables\UserTable;
use Woo\ACL\Http\Requests\CreateUserRequest;
use Woo\ACL\Http\Requests\UpdatePasswordRequest;
use Woo\ACL\Http\Requests\UpdateProfileRequest;
use Woo\ACL\Models\UserMeta;
use Woo\ACL\Repositories\Interfaces\RoleInterface;
use Woo\ACL\Repositories\Interfaces\UserInterface;
use Woo\ACL\Services\ChangePasswordService;
use Woo\ACL\Services\CreateUserService;
...
use Woo\ACL\Http\Requests\AvatarRequest;
use Exception;
