...
namespace Woo\Setting\Http\Controllers;

use Assets;
use BaseHelper;
use Woo\Base\Http\Controllers\BaseController;
use Woo\Base\Http\Responses\BaseHttpResponse;
use Woo\Base\Supports\Core;
use Woo\Base\Supports\Language;
use Woo\Media\Repositories\Interfaces\MediaFileInterface;
use Woo\Setting\Http\Requests\EmailTemplateRequest;
use Woo\Setting\Http\Requests\LicenseSettingRequest;
use Woo\Setting\Http\Requests\MediaSettingRequest;
use Woo\Setting\Http\Requests\ResetEmailTemplateRequest;
use Woo\Setting\Http\Requests\SendTestEmailRequest;
use Woo\Setting\Http\Requests\SettingRequest;
