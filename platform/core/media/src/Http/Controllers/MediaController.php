...
namespace Woo\Media\Http\Controllers;

use Woo\Media\Http\Resources\FileResource;
use Woo\Media\Http\Resources\FolderResource;
...
use Woo\Media\Services\UploadsManager;
