...
namespace Theme\WooMarketplace\Http\Controllers;

use Woo\Base\Enums\BaseStatusEnum;
use Woo\Base\Http\Responses\BaseHttpResponse;
use Woo\Blog\Repositories\Interfaces\PostInterface;
...
use Woo\Ecommerce\Services\Products\GetProductService;
use Woo\Theme\Http\Controllers\PublicController;
use Cart;
use EcommerceHelper;
use EmailHandler;
use Illuminate\Http\Request;
use Theme;
use Theme\WooMarketplace\Http\Requests\SendDownloadAppLinksRequest;
use Theme\WooMarketplace\Http\Resources\BrandResource;
use Theme\WooMarketplace\Http\Resources\PostResource;
use Theme\WooMarketplace\Http\Resources\ProductCategoryResource;
use Theme\WooMarketplace\Http\Resources\ReviewResource;

class WooMarketplaceController extends PublicController
{
