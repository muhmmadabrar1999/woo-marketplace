(function ($) {
    ...
    window.WooCookieNewsletter = (() => {

        const COOKIE_VALUE = 1;
        const COOKIE_NAME = 'Woo_cookie_newsletter';
    ...
    $(document).ready(function () {
        ...
        $('.ps-popup__close').on('click', function (e) {
            ...
            window.WooCookieNewsletter.hideCookieDialog();
        });
        ...
        $(document).on('click', '.newsletter-form button[type=submit]', function (event) {
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    if (!res.error) {
                        window.WooCookieNewsletter.newsletterWithCookies(30);
