@php
    $brands = get_all_brands(['status' => \Woo\Base\Enums\BaseStatusEnum::PUBLISHED], ['slugable'], ['products']);

    $tags = app(\Woo\Ecommerce\Repositories\Interfaces\ProductTagInterface::class)->advancedGet([
        'condition' => ['status' => \Woo\Base\Enums\BaseStatusEnum::PUBLISHED],
        'with'      => ['slugable'],
        'withCount' => ['products'],
