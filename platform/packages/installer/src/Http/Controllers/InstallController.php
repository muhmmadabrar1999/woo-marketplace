...
namespace Woo\Installer\Http\Controllers;

use BaseHelper;
use Woo\ACL\Models\User;
use Woo\ACL\Services\ActivateUserService;
use Woo\Installer\Events\EnvironmentSaved;
use Woo\Installer\Events\InstallerFinished;
use Woo\Installer\Http\Requests\SaveAccountRequest;
use Woo\Installer\Http\Requests\SaveEnvironmentRequest;
use Woo\Installer\Supports\EnvironmentManager;
use Woo\Installer\Supports\RequirementsChecker;
use Carbon\Carbon;
use Exception;
use File;
