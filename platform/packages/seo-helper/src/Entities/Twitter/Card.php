...
namespace Woo\SeoHelper\Entities\Twitter;

use Woo\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Woo\SeoHelper\Contracts\Entities\TwitterCardContract;
use Woo\SeoHelper\Exceptions\InvalidTwitterCardException;
