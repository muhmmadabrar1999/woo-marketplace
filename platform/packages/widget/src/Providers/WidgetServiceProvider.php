...
namespace Woo\Widget\Providers;

use BaseHelper;
use Woo\Base\Traits\LoadAndPublishDataTrait;
use Woo\Widget\Factories\WidgetFactory;
use Woo\Widget\Models\Widget;
use Woo\Widget\Repositories\Caches\WidgetCacheDecorator;
use Woo\Widget\Repositories\Eloquent\WidgetRepository;
use Woo\Widget\Repositories\Interfaces\WidgetInterface;
use Woo\Widget\WidgetGroupCollection;
use Woo\Widget\Widgets\Text;
...
class WidgetServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind('Woo.widget', function (Application $app) {
            return new WidgetFactory($app);
        });

        $this->app->singleton('Woo.widget-group-collection', function (Application $app) {
